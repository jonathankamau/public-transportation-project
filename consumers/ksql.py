...
CREATE TABLE turnstile (
    station_id INT, station_name STRING, line STRING
) WITH (
    KAFKA_TOPIC = 'org.udacity.public.transportation.station',
    VALUE_FORMAT = 'JSON',
    KEY = 'station_id'
);
...
WITH (
    ...
    SELECT CAST(COUNT(station_id)) as count, station_name, line
    FROM turnstile
    GROUP BY station_id
"""
